...
from Wrappers import BlackJack_builder as env_builder
...
nTests= 1000 # Environment tests
RewardSolved= -0.05 # Reward for which the environment is considered solved
nPop= 100 # CHC's population size
nRules= 10 # CHC's solution number of rules
