...
from Wrappers import FrozenLakeNonSlippery_builder as env_builder


DEBUG= False

num_exper= 30
dataName= 'FrozenLake-v1'
method= 'QRBS'
algorithmName= 'CHC'


nTests= 1 # Environment tests
RewardSolved= 1 # Reward for which the environment is considered solved
nPop= 50 # CHC's population size
nRules= 4 # CHC's solution number of rules
