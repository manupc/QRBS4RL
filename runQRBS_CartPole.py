...
from Wrappers import CartPole_builder as env_builder

    
DEBUG= False

num_exper= 30
dataName= 'CartPole-v1'
method= 'QRBS'
algorithmName= 'CHC'

nTests= 100 # Environment tests
RewardSolved= 500 # Reward for which the environment is considered solved
